 ...
 ZCRMRestClient.initialize = function(configJSON){
    return new Promise(function(resolve,reject){
        if(configJSON){
            ...
            var mysqlhost = configJSON.mysql_password?configJSON.mysql_password:mysql_password;
            var mysqldatabase = configJSON.mysql_password?configJSON.mysql_password:mysql_password;
            var mysqlsocket = configJSON.mysql_password?configJSON.mysql_password:mysql_password;
            ...
            ZCRMRestClient.setMySQLHost(mysqlhost);
            ZCRMRestClient.setMYSQLDatabase(mysqldatabase);
            ZCRMRestClient.setMYSQLSocketPath(mysqlsocket);
...
ZCRMRestClient.setMySQLHost = function(mysqlhost){
    mysql_host = mysqlhost;
}
ZCRMRestClient.setMYSQLDatabase = function(mysqldatabase){
    mysql_database = mysqldatabase;
}
ZCRMRestClient.setMYSQLSocketPath = function(mysqlsocket){
...
ZCRMRestClient.getMySQLHost = function(){
    return mysql_host;
}
ZCRMRestClient.getMySQLDatabase = function(){
    return mysql_database;
}
ZCRMRestClient.getMySQLSocketPath = function(){
    return mysql_socket;
}
